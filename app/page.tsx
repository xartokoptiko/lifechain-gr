...
export default function Home() {
  ...
  return (
    <main>
      ...
      <div className="flex flex-col w-full py-[100px] max-sm:flex-col items-center justify-center">
        <section className="bg-white dark:bg-gray-900 max-w-4xl">
          <div className="container px-6 py-10 mx-auto max-sm:flex-col">
            <div className="lg:flex lg:items-center">
              ...
              <div className="flex flex-row flex-grow items-end justify-end">
                <img
                  className="w-[190px] h-[400px] rounded-lg shadow-xl shadow-redonebg"
        ...
        <section className="bg-white dark:bg-gray-900 mt-[100px]">
          <div className="container px-6 py-10 mx-auto max-w-4xl">
            <div className="lg:flex lg:items-center max-sm:flex-col">
